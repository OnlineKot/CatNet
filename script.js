...
const catFacts = [
    ...
    "Każdy nosek kota ma niepowtarzalny wzór, tak jak ludzki odcisk palca.",
    ...
    "Koty potrafią śnić. Poruszają wtedy wąsami i łapkami.",
    ...
    "Słuch kota sięga znacznie wyżej niż ludzki i łapie ultradźwięki.",
    ...
    "Koty to mięsożercy, więc najlepszą przekąską jest dla nich mięso.",
    ...
    "Freud jest najsłodszym kotem na świecie. To nie podlega dyskusji.",
    ...
    "Freud, kot, którego właśnie oglądasz, jest po prostu najsłodszy."
];

const catFactsEn = [
    "Cats sleep between 12 and 16 hours a day.",
    "A cat can make over 100 different sounds, while a dog makes only about 10.",
    "Every cat's nose has a unique pattern, just like a human fingerprint.",
    ...
    "A cat experiences the world mostly through smell. It has millions of scent receptors.",
    ...
    "A cat's hearing reaches much higher than a human's, all the way into ultrasound.",
    ...
    "Cats are carnivores, so meat is the best snack for them.",
    ...
    "Freud is the cutest cat in the world. This is not up for debate.",
    ...
    "Freud, the cat you're looking at right now, is simply the cutest."
];
...
const translations = {
    pl: {
        ...
        "quizcta.sub": "Sześć pytań. Na końcu dowiesz się, ile procent kota w Tobie siedzi.",
        "quizcta.btn": "Sprawdź się",
        "footer.made": "Najsłodsze obrazki kotów na świecie",
        "hero.badge": "Nowe: koty od społeczności, Deluxe i kocięta",
        "marquee.items": "Losowe koty · Nowe po każdym kliknięciu · Ulubione zostają w przeglądarce · ",
        "rm.title": "Co dalej? Mapa mruczeń",
        "rm.sub": "Nad czym teraz pracujemy.",
        "rm.soon": "WKRÓTCE",
        "rm1t": "Meow Mode", "rm1d": "Kliknij kota i usłysz miau.",
        "rm2t": "Kot Dnia", "rm2d": "Codziennie o północy jeden nowy kot.",
        "rm3t": "Quiz: Jakim kotem jesteś?", "rm3d": "Kilka pytań i poznasz swoje kocie alter ego.",
        "rm4t": "Tapety z kotami", "rm4d": "Koty w wysokiej jakości, gotowe na tapetę telefonu.",
        "rm5t": "CatNet w kieszeni", "rm5d": "Zainstaluj CatNet jak aplikację i oglądaj koty także bez internetu.",
        "rm6t": "Galeria Freuda", "rm6d": "Więcej zdjęć Freuda.",
        "hero.h1": 'Najsłodsze obrazki <span class="grad">kotów</span><br>na świecie',
        ...
        "home.todayTitle": "Koty na dziś", "home.todaySub": "Kilka kotów prosto z galerii.",
        ...
        "facts.sweetCaption": "Freud w swoim ogrodzie",
        ...
        "about.p2": "Zdjęcia pochodzą z otwartych API <strong>TheCatAPI</strong> oraz <strong>Cataas</strong>, więc przy każdym odświeżeniu zestaw jest inny.",
        "stat.infinite": "otwarte API (TheCatAPI, Cataas)", "stat.free": "reklam i kont", "stat.joy": "języki interfejsu",
        "about.whyTitle": "Jak to działa",
        "feat1.t": "Losowe koty", "feat1.p": "Zdjęcia losowane z dwóch otwartych API. Odświeżaj, ile chcesz.",
        "feat2.t": "Twoje ulubione", "feat2.p": "Zapisuj koty jednym kliknięciem. Zostaną w Twojej przeglądarce.",
        "feat3.t": "Bez kont i reklam", "feat3.p": "Statyczna strona bez logowania i bez śledzenia reklamowego.",
        "feat4.t": "Telefon i komputer", "feat4.p": "Ten sam układ działa na telefonie, tablecie i komputerze.",
        ...
        "err404.text": "Szukasz kotów nie tam, gdzie trzeba. Wróć na stronę główną, tam ich nie brakuje.",
        "err404.btn": "Wróć na stronę główną",
        "cookie.text": "Pomóż nam ulepszać CatNet i zgódź się na anonimową analitykę. Bez reklam, bez sprzedaży danych, bez śledzenia między stronami.",
        ...
        "priv.intro": "CatNet to prosty, darmowy serwis ze zdjęciami kotów. Traktujemy Twoją prywatność poważnie i celowo zbudowaliśmy stronę tak, aby zbierać jak najmniej danych. Ta polityka wyjaśnia wprost i w całości, co dzieje się z danymi podczas korzystania z serwisu.",
        ...
        "simple.text": "Wyłącza ruchome tło i animacje, dzięki czemu strona działa lżej i szybciej. W każdej chwili zmienisz to w ustawieniach.",
        ...
        "pg.catsToday": "kotów dziś", "pg.streakHint": "Twoja passa. Wróć jutro, żeby ją przedłużyć.",
        "pg.days": "dni", "pg.showTutorial": "▶ Pokaż samouczek",
        "onb.s1t": "Witaj w CatNet!", "onb.s1p": "W kilka sekund pokażemy, jak to działa.",
        "onb.s2t": "Odkrywaj koty", "onb.s2p": "Odświeżaj galerię i oglądaj nowe koty bez końca.",
        ...
        "toast.favSaved": "Zapisano w ulubionych",
        ...
        "blocked.text": "Wygląda na to, że Twoja przeglądarka lub <strong>AdBlock</strong> blokuje połączenie. Wyłącz blokowanie reklam i odśwież stronę. Inaczej koty się nie załadują.",
    ...
    en: {
        ...
        "quizcta.sub": "Six questions. At the end you'll find out what percent cat you are.",
        "quizcta.btn": "Test yourself",
        "footer.made": "The cutest cat pictures in the world",
        "hero.badge": "New: Community, Deluxe & kitten cats!",
        "marquee.items": "Random cats · New ones on every click · Favourites stay in your browser · ",
        "rm.title": "What's next? The purr roadmap",
        "rm.sub": "What we are working on right now.",
        "rm.soon": "SOON",
        "rm1t": "Meow Mode", "rm1d": "Click a cat and hear a meow.",
        ...
        "rm4t": "Cat wallpapers", "rm4d": "Cats in high quality, ready to use as a phone wallpaper.",
        "rm5t": "CatNet in your pocket", "rm5d": "Install CatNet like an app and browse cats offline too.",
        "rm6t": "Freud's gallery", "rm6d": "More photos of Freud.",
        "hero.h1": 'The cutest <span class="grad">cat</span><br>pictures in the world',
        ...
        "fact.label": "Cat fact",
        "home.todayTitle": "Cats for today", "home.todaySub": "A few cats straight from the gallery.",
        ...
        "facts.sweetTitle": "Freud",
        "facts.sweetCaption": "Freud in his garden",
        ...
        "about.p1": "CatNet is a simple cat photo gallery. One click refreshes the next batch, no login and no fees.",
        ...
        "stat.infinite": "open APIs (TheCatAPI, Cataas)", "stat.free": "ads and accounts", "stat.joy": "interface languages",
        "about.whyTitle": "How it works",
        "feat1.t": "Random cats", "feat1.p": "Photos drawn at random from two open APIs. Refresh as much as you like.",
        "feat2.t": "Your favorites", "feat2.p": "Save cats with one click. They stay in your browser.",
        "feat3.t": "No accounts, no ads", "feat3.p": "A static site with no login and no advertising trackers.",
        "feat4.t": "Phone and desktop", "feat4.p": "The same layout works on phone, tablet and desktop.",
        ...
        "err404.text": "You're looking for cats in the wrong place. Head back to the homepage, there are plenty there.",
        "err404.btn": "Back to homepage",
        "cookie.text": "Help us improve CatNet by allowing anonymous analytics. No ads, no data selling, no cross-site tracking.",
        ...
        "simple.text": "Turns off the moving background and animations, so the site runs lighter and faster. You can change this anytime in settings.",
        ...
        "onb.s1t": "Welcome to CatNet!", "onb.s1p": "We will show you how it works in a few seconds.",
        "onb.s2t": "Discover cats", "onb.s2p": "Refresh the gallery and watch new cats endlessly.",
        ...
        "toast.favSaved": "Saved to favourites",
        ...
        "blocked.text": "It looks like your browser or <strong>AdBlock</strong> is blocking the connection. Turn off ad blocking and refresh the page. Otherwise the cats will not load.",
...
const QUIZ = {
    pl: {
        ...
        sub: "Sześć pytań o całkiem ludzkie sprawy. Na końcu policzymy, ile procent kota w Tobie siedzi.",
        start: "Sprawdźmy",
        of: "z",
        ...
        tiers: [
            { min: 80, e: "", n: "Zdecydowanie kot", d: "Nie ma wątpliwości: w środku jesteś kotem niemal w stu procentach. Drzemki, niezależność i ciepłe miejsca to Twój żywioł. Brakuje Ci tylko ogona i wąsów." },
            ...
            { min: 0, e: "", n: "Człowiek (na razie)", d: "Energiczny, towarzyski, poukładany. To bardzo ludzkie cechy. Ale spokojnie: jeszcze kilka drzemek na słońcu i parę pudełek, a dołączysz do kociego klubu." }
        ]
    },
    en: {
        title: "Are you a cat?",
        sub: "Six questions about very human things. At the end we work out what percent cat you are.",
        ...
        q: [
            { q: "Someone moved your things around on your desk.", a: [
                ...
                { t: "It's my territory, back to the millimetre", v: 3 } ] },
        ...
        tiers: [
            { min: 80, e: "", n: "Definitely a cat", d: "No doubt about it: inside, you are very nearly one hundred percent cat. Naps, independence and warm spots are your element. You're only missing a tail and whiskers." },
            ...
            { min: 0, e: "", n: "Human (for now)", d: "Energetic, sociable, organised. Those are very human traits. But relax: a few more naps in the sun and a couple of boxes and you'll join the cat club." }
        ]
    }
};
