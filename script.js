...
const translations = {
    pl: {
        ...
        "priv.s1p": "Nie używamy Google Analytics, pikseli reklamowych, narzędzi śledzących ani żadnej innej analityki. Nie budujemy profili, nie wyświetlamy reklam i nie sprzedajemy żadnych danych. Nie mamy kont użytkowników ani logowania.",
    ...
    en: {
        ...
        "priv.s1p": "We do not use Google Analytics, advertising pixels, tracking tools or any other analytics. We don't build profiles, show ads, or sell any data. We have no user accounts and no login.",
