...
const translations = {
    pl: {
        ...
        "foss.note": "Cześć! 👋 CatNet to mój prywatny projekt, robiony po prostu dla zabawy i z miłości do kotów — w duchu open source: otwarcie i przejrzyście. Bez reklam, bez kont, a ulubione i historia są zapisywane tylko w Twojej przeglądarce. Używam jedynie anonimowej analityki (Microsoft Clarity), żeby wiedzieć, co poprawić — nie sprzedaję żadnych danych. Niczego złego, obiecuję. 🐾",
    ...
    en: {
        ...
        "foss.note": "Hi! 👋 CatNet is my personal little project — built just for fun and out of love for cats, in an open-source spirit: open and transparent. No ads, no accounts, and your favorites and history are stored only in your browser. I only use anonymous analytics (Microsoft Clarity) to see what to improve — I don't sell any data. Nothing shady, promise. 🐾",
