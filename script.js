...
const translations = {
    pl: {
        ...
        "seo.h": "Darmowa galeria zdjęć kotów online",
        "seo.p": "CatNet to prosta, darmowa galeria zdjęć kotów. Jednym kliknięciem odświeżasz kolejne koty, oglądasz nieskończony strumień uroczych zdjęć, a ulubione zapisujesz w przeglądarce — bez reklam, bez logowania i bez opłat. Zdjęcia kotów pochodzą z otwartych API TheCatAPI i Cataas, więc za każdym razem czeka na Ciebie nowa porcja mruczących bohaterów.",
    ...
    en: {
        ...
        "seo.h": "A free online cat photo gallery",
        "seo.p": "CatNet is a simple, free gallery of cat photos. One click refreshes new cats, you browse an endless stream of adorable pictures, and your favourites are saved in your browser — no ads, no login and no fees. The cat photos come from the open TheCatAPI and Cataas APIs, so every refresh brings a fresh batch of purring stars.",
